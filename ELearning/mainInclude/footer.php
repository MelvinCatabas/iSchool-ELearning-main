...
>>>>>>> Stashed changes
 ...
 <!-- Start Instructr Login Modal -->
 <div class="modal fade" id="instLoginModalCenter" tabindex="-1" role="dialog" aria-labelledby="stuLoginModalCenterTitle" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered" role="document">
     <div class="modal-content">
       <div class="modal-header" style="border:none;">
         <!-- <h5 class="modal-title" id="stuLoginModalCenterTitle">Student Login</h5> -->
         ...
         <div class="row justify-content-center">
           ...
           <h5 class="fw-normal mb-3 pb-3 text-center" style="letter-spacing: 1px; font-size:24px;">Instructor</h5>
             ...
             <form role="form" id="stuRegForm">
               <div class="form-outline mb-4">
                 <label class="form-label" for="stuLogEmail">Name</label>
                 <input type="text" class="form-control form-control-lg" style="height:40px; font-size:16px;" placeholder="Instructor" name="stuLogEmail" id="stuLogEmail">
               </div>
