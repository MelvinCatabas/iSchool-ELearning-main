  ...
  <nav class="col-sm-3 col-md-2 sidebar py-5 d-print-none">
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
     <div class="sidenav-header">
       ...
       <a class="navbar-brand m-0" href="\iSchool-ELearning-main\ELearning\index.php" style="height: 400px;">
         <img  src="../image/stu/<?php echo $stu_img?>"  class="navbar-brand-img h-100" style="border-radius: 150px; height: 200px;" alt="main_logo">
     ...
     <div class="collapse navbar-collapse  w-auto" style="height:400px;" id="sidenav-collapse-main">
       <ul class="navbar-nav">
       <li class="nav-item">
         <a class="nav-link <?php if(PAGE == 'index') {echo 'active';} ?>" href="\iSchool-ELearning-main\ELearning\index.php">
